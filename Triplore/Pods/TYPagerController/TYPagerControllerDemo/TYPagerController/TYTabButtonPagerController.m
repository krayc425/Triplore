...
- (void)configureTabButtonPropertys
{
    ...
    _progressColor = [UIColor colorWithRed:0.0 green:204.0/255.0 blue:204.0/255.0 alpha:1.0];
...
- (void)setBarStyle:(TYPagerBarStyle)barStyle
{
    ...
    if (barStyle == TYPagerBarStyleCoverView) {
        ...
        self.progressColor = [UIColor colorWithRed:0.0 green:204.0/255.0 blue:204.0/255.0 alpha:1.0];
    }
