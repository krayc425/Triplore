...
- (void)startImageAsynchronous;

- (void)startDownloadAsynchronous; // max concurrent count = 4
...
@property (atomic, retain) NSString *userAgent;
...
@property (atomic, assign) NSTimeInterval persistentConnectionTimeoutSeconds;
...
@property (nonatomic, assign)  int offline_downloader;
@end
