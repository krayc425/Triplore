...
+ (TPNoteTemplate *)getTemplateOfNum:(TPNoteTemplateNumber)number{
    switch (number) {
        case TPGreen:
        {
            ...
            return [[TPNoteTemplate alloc] initWithColor:[UIColor whiteColor] andFont:[Utilities getFont] andTitleView:titleView andImageStyle:TPGreen];
        }
            break;
        case TPBrown:
        {
            TPNoteTitleViewBrown *titleView = [[[NSBundle mainBundle] loadNibNamed:@"TPNoteTitleViewBrown" owner:nil options:nil] lastObject];
            return [[TPNoteTemplate alloc] initWithColor:[UIColor colorWithRed:247.0/255.0 green:244.0/255.0 blue:243.0/255.0 alpha:1.0] andFont:[Utilities getFont] andTitleView:titleView andImageStyle:TPBrown];
        }
            break;
        default:
            break;
