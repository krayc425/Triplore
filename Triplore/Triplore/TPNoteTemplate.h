...
- (instancetype)initWithColor:(UIColor *_Nonnull)color andFont:(UIFont *_Nonnull)font andTitleView:(TPNoteTitleView *_Nonnull)titleView andImageStyle:(TPNoteTemplateNumber)number;
